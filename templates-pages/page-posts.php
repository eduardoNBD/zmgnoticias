...
<div class="max-w-7xl mx-auto px-4 py-6">
    <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 md:col-span-8">
            <?php if ( is_author() ) {
                $author_id = get_queried_object_id(); // ID del autor del archivo
                echo "<h2 class='text-2xl font-bold mb-4'>Publicaciones de " . esc_html( get_the_author_meta('display_name', $author_id) ) . "</h2>";
            } ?>
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                            ...
                            <div class="p-4">
                                ...
                                <div class="text-xs text-gray-500 flex justify-between gap-3">
                                    <span>
                                        <a class="font-bold" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta('ID') ) ); ?>"><?php echo esc_html( get_the_author() ); ?></a>
                                    </span>
